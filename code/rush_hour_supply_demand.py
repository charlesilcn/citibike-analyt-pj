...
def main():
    # 1. 路径配置（适配你的文件夹结构）
    featured_data_path = "../processed_data/2020_featured.csv"  # 特征工程后的数据
    result_save_dir = "../results/supply_demand_analysis"  # 供需分析结果保存目录
    charts_save_dir = "../results/charts"  # 图表保存目录（复用之前的charts文件夹）
